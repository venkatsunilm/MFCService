...
public class windowHelper {
     ...
     */
    public @Nullable
    AccessibilityWindowInfo getCurrentWindow(boolean useInputFocus) {
     ...
     */
    public @Nullable
    AccessibilityWindowInfo getPreviousWindow(AccessibilityWindowInfo pivotWindow) {
     ...
     */
    public @Nullable
    AccessibilityWindowInfo getAnchoredWindow(
            @Nullable AccessibilityNodeInfoCompat targetAnchor) {
        if (true/*!BuildVersionUtils.isAtLeastN()*/ || targetAnchor == null) {
            return null;
        }
